...
// peer; node_alias IS here (added 2026-07-12) so the node name syncs across devices. Both
// are additive + not fund-critical, and older backups without them still restore (the frozen
// golden envelopes below have neither and must keep decrypting).

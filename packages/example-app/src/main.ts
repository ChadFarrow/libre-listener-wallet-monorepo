...
newWalletBtn.addEventListener("click", async () => {
  ...
  // Hex seed is the primary artifact (simplest). The 24-word BIP39 phrase is an
  // optional export for moving to another wallet — available via "Show recovery
  // phrase" — so keep its box hidden here.

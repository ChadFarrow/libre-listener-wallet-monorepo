...
// Convert an on-chain Bitcoin address to its scriptPubKey bytes, for sweeping force-closed funds to
// an address the user supplies. Supports segwit: P2WPKH/P2WSH (v0, bech32) and P2TR / future witness
// versions (v1+, bech32m). Legacy base58 (1.../3...) is unsupported. (Ported from the PWA's
// core/address-script.ts — the extension can't import the app package.)
